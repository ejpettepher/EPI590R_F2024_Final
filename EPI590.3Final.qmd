...
```{r}
#| label: tbl-two
#| tbl-cap: "A logistical regression model was fitted to the sample data and exponentiated to determine the odds of improving given the above characteristics"
```